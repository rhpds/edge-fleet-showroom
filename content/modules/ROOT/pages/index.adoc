...
In this lab you will be utilizing the following Red Hat software components which
have already been preinstalled for you
...
(Ken: I left this default section here because I wasn't sure what will initially be viewable to students 'on the right' - will it be ACM/OCP Login window?)
