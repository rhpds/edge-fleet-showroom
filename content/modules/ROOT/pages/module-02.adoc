...
a Mobile Device, skip this section by clicking https://showroom-showroom-rhfnr-{user}.apps.cluster-rhfnr.dynamic.redhatworkshops.io/content/modules/module-02.html#_qr_code_enrollment_via_web_browser[here] to go to the *Option 2: QR Code Enrollment via Web Browser* section (you can also select this section in the *Contents*
...
NOTE: Observe that we receive an, *"Application is not available"* error message (this is expected at this time because our 'base' device image does not contain
