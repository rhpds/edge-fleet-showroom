...
KEN: UPDATE THE ABOVE SCREENSHOT ONCE NAV IS COMPLETE 
...
Keep the Application Brower Tab open and return to the Routes Tab in the OpenShift UI
...
We are now going to join our new store device to the existing *'point-of-sale-prod'* fleet we examined earlier. 
...
In this Lesson, you learned how to onboard a new store edge device into Edge Manager.  
