...
NOTE: If you have a Mobile Device, continue with the steps indicated below.  If you do not have
a Mobile Device, skip this section by clicking https://showroom-showroom-rhfnr-{user}.apps.cluster-rhfnr.dynamic.redhatworkshops.io/content/modules/module-02.html#wbe[here] to go to the *Option 2: QR Code Enrollment via Web Browser* section (you can also select this section in the *Contents*
right-hand navigation menu)
