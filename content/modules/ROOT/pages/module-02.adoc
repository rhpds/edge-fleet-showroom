...
a Mobile Device, skip this section by scrolling down to the *QR Code Enrollment via Web Browser* section (you can also select this section in the *Contents*
...
. (In your Lab Manual) expand the upper-right hand *Links*
...
of the fleet device template.  You will also explore the Edge Manager command line interface along with how to further monitor and decommision devices.