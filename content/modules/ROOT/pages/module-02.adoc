...
a Mobile Device, skip this section by clicking https://showroom-showroom-{guid}-{user}.apps.cluster-rhfnr.dynamic.redhatworkshops.io/content/modules/module-02.html#option-2-anchor[here] to go to the *Option 2: QR Code Enrollment via Web Browser* section (you can also select this section in the *Contents*
