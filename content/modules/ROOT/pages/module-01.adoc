...
. A *device selector* label has been configured: '*pos=prod*' This is a user generated key-pair value of their choosing. _Any devices that matches (contains) this label 
will automatically be made a member of this fleet_
