...
=== Lab Login
. Click link:{console_url}[here,window=_blank] to access your Lab Environment<br>

[cols="1,1", options="header"]
|===
| Username | Password
| {z_gitea_web_ui_username} | {z_gitea_web_ui_password}
| {z_ansible_controller_admin_username} | {z_ansible_controller_admin_password}
|===


=== Lab Login
. Click {console_url}[here,window=_blank] to access your Lab Environment
+
