...
Fleet specifications can be set for all devices that are members of a fleet.  This functionality allows users to declaritively specify their desired state for Edge Devices and subsequently rely
